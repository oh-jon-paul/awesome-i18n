...
- [Dire](https://github.com/juliandreas/dire-cli) - Go-based CLI that automatically processes missing translations in your i18n files using translation and AI providers, glossary definitions, and translation memory
